...
<a href="index.php" class="logo">
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle" src="../img/moi.jpg" alt="User profile picture">

              <h3 class="profile-username text-center">Clotilde Dessange</h3>

              <p class="text-muted text-center">Patient Atoline depuis Mai 2017</p>

              <ul class="list-group list-group-unbordered">
                <li class="list-group-item">
                  <b>Dibètique</b> <a class="pull-right"> Type 1</a>
                </li>
                <li class="list-group-item">
                  <b>Traitement</b> <a class="pull-right">Basale et Bolus</a>
                </li>
                <li class="list-group-item">
                  <b>Taux Glycémie actuel</b> <a class="pull-right">80</a>
                </li>
              </ul>

              <a href="#myModal" class="btn btn-primary btn-block" role="button" data-toggle="modal"><b>Contacter</b></a>
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Spécificités</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <p class="text-muted">Paris 13, France</p>
              ...
              <p>A tendance à avoir des hypoglycémie durant ses nuits, particulièrement en été.</p>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="#timeline" data-toggle="tab">Urgence</a></li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2017 Atoline
  </footer>
