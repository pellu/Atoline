...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
      <a href="index.php">
        <img src="../img/logo_pro.png" width="150px"></a>
      </div>
      <div class="login-box-body">
        ...
        <p>Pour vous inscrire en tant que médecin sur Atoline vous devez contacter Atoline <a href="mailto:medecin@atoline.com">medecin@atoline.com</a></p>
      </div>
    </div>
